...
import "../../stylesheets/resultat.css";
              ...
              <div className="resultat-midt-div">
                  ...
                  <div className="resultat-høyre-div">
                      <div className="resultat-tekstBoks1">
                          ...
                          <button className="resultat-btn"type="button" onClick={handleClick}>Ta meg videre</button>
                      </div>
                      <div className="resultat-tekstBoks2">
                          ...
                          <button className="resultat-btn"type="button">Print diplom</button>
                      </div>
                  </div>
              </div>
          </div>
