            ...
            <div className="bgBoxContainer">
              <div className="bgBox">
                <div className="text">
                  ...
                  1900-tallet. Gjennom Næss' innflytelse fikk analytisk filosofi
                  en dominerende stilling i Norge i tiårene etter andre
                  verdenskrig. Han var også kjent som fjellklatrer, friluftsmann
                  og aktivist i norsk natur- og miljøvern. I Norge ble han
                  særlig kjent gjennom sin deltakelse i aksjonene mot
                  utbyggingen av Mardøla (1970) og Alta (1979–1981, se
                  Alta-saken). Næss regnes som grunnleggeren av dypøkologien som
                  filosofisk retning.
                </div>
              </div>
            </div>
      ...
      <div className="container">
        <div className="infoContainer">
          ...
          <div className="box">
            ...
            <div className="h3">
              Proffessor, fjellklatrer, Ridder av St. Olavs Orden. Men hvem var
              Arne Næss egentlig
            </div>
            <div className="h4">
              ...
              veldig innflytningsrik filosof. Arne sine ideer om verden er like
              aktuelle idag som de var når han levde.
            </div>
          </div>
        </div>
        ...
        <div className="infoContainer2">
          <div className="box2">
            ...
            <button className="btn">Kunnskapssamlingen</button>
          </div>
